...
// Best Practice: Define metadata in a dictionary ('args').
// Why? This allows you to Reuse this data in the document body (e.g. #args.date).
// Without this, you'd have to repeat the date in the content, risking inconsistency.
#let args = (
  title: "Hello World",
  date: "2025-12-27",
  author: "Bob",
